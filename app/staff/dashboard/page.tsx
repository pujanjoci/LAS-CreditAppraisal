...
export default function StaffDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Link
            ...
            className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg bg-accent-600 text-white text-sm font-medium hover:bg-accent-700 transition-colors shadow-sm"
          >
            <FileText className="h-3.5 w-3.5" /> New Memo
          </Link>
          <Link
            href="/staff/new-appraisal"
            className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg bg-white border border-slate-200 text-slate-700 text-sm font-medium hover:bg-slate-50 transition-colors"
          >
            + New Appraisal
          </Link>
        </div>
      ...
      {/* Memo Quick Access */}
      <Card className="border-accent-100 bg-accent-50/30 overflow-hidden">
        <CardContent className="p-0">
          <div className="flex flex-col md:flex-row md:items-center justify-between p-5 gap-4">
            ...
            <div className="flex gap-2 w-full md:w-auto">
              <Link href="/staff/memo/create" className="flex-1 md:flex-none text-center px-4 py-2 rounded-lg bg-white border border-slate-200 text-xs font-medium text-slate-700 hover:bg-slate-50 transition-colors">
                Create Memo
              </Link>
              <Link href="/staff/memo/review" className="flex-1 md:flex-none text-center px-4 py-2 rounded-lg bg-accent-600 text-xs font-medium text-white hover:bg-accent-700 transition-colors shadow-sm">
                Review Queue
              </Link>
            </div>
          </div>
